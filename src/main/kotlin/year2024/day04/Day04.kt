...
fun main() {
    ...
    val diagonalRightDown =
        XmasStrategy(0, 3, 0, 3, { row, offset -> row + offset }, { column, offset -> column + offset })
    val diagonalLeftDown =
        XmasStrategy(0, 3, 3, 0, { row, offset -> row + offset }, { column, offset -> column - offset })
    val diagonalRightUp =
        XmasStrategy(3, 0, 0, 3, { row, offset -> row - offset }, { column, offset -> column + offset })
    val diagonalLeftUp =
        XmasStrategy(3, 0, 3, 0, { row, offset -> row - offset }, { column, offset -> column - offset })
